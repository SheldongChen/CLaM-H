...
def plot_t2m(data, save_dir, captions):
    ...
    for i, (caption, joint_data) in enumerate(zip(captions, data)):
        ...
        plot_3d_motion(save_path, paramUtil.motionx_kinematic_chain, joint, title=caption, fps=20)
...
#         )
        ...
        'Comp_v6_KLD005': lambda: get_motion_loader(
            './checkpoints/motionx/Comp_v6_KLD005/opt.txt',
            batch_size, gt_dataset, mm_num_samples, mm_num_repeats, device
        ),
    }
    ...
    log_file = './evaluation_motionx.log'
    evaluation(log_file)
